...
module.exports = {"first":"first___2RhWJ","main":"main___3NM49"};;
    if (true) {
...
// extracted by mini-css-extract-plugin
module.exports = {"main":"main___10XBn"};;
    if (true) {
      var injectCss = function injectCss(prev, href) {
        var link = prev.cloneNode();
        link.href = href;
...
// extracted by mini-css-extract-plugin
module.exports = {"slideshow__container":"slideshow__container___3xrVj","mySlides":"mySlides___2oXCc","prev":"prev___ws7Uw","next":"next___X4er9","text__block":"text__block___3rM_Y","show__curentSlide":"show__curentSlide___2C5NB","dot":"dot___316xS","active":"active___2g1BY","fade":"fade___35iCJ","zooming":"zooming___1fOkY","textBoxEff":"textBoxEff___1BIs6"};;
    if (true) {
      var injectCss = function injectCss(prev, href) {
        var link = prev.cloneNode();
        link.href = href;
...
// extracted by mini-css-extract-plugin
module.exports = {"downTriAngle":"downTriAngle___cEhgv"};;
    if (true) {
      var injectCss = function injectCss(prev, href) {
        var link = prev.cloneNode();
        link.href = href;
